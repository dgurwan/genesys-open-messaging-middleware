...
/**
 * Compares two strings using a timing-safe comparison.
 */
...
/**
 * Validates the Genesys webhook signature against the raw request body.
 */
export function verifyGenesysSignature({ rawBody, headerValue, secret }) {
  ...
  return accepted.some((candidate) =>
    timingSafeEqualsString(candidate, headerValue || ""),
  );
}

/**
 * Validates the Sinch webhook signature, nonce and timestamp.
 */
